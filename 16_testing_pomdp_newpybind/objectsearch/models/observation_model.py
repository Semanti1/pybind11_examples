...
#### Observation Models ####
class MosObservationModel(OOObservationModel):
    ...
    def __init__(self,
        ...
        OOObservationModel.__init__(self, observation_models)
...
class ObjectObservationModel(ObservationModel):
